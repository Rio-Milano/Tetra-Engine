...
public:
	...
	void Init() override final
	{
		...
		std::shared_ptr<Model>
			...
			backPack = MeshManager.LoadModel("Data/Models/backpack/backpack.obj");//back pack is an optional extension
		...
		ngun->GetChildren()[0]->GetMeshes()[0]->m_diffuse = aquaPigDiffuse;
		ngun_base->GetChildren()[0]->GetMeshes()[0]->m_diffuse = aquaPigDiffuse;
		nhull->GetChildren()[0]->GetMeshes()[0]->m_diffuse = aquaPigDiffuse;
		npropeller->GetChildren()[0]->GetMeshes()[0]->m_diffuse = aquaPigDiffuse;
		nwing_left->GetChildren()[0]->GetMeshes()[0]->m_diffuse = aquaPigDiffuse;
		nwing_right->GetChildren()[0]->GetMeshes()[0]->m_diffuse = aquaPigDiffuse;

		std::shared_ptr<Texture> aquaPigSpecular = TextureManager.GetTexture("AquaPigSpecular");

		//assign the diffuse texture to each mesh
		ngun->GetChildren()[0]->GetMeshes()[0]->m_specular = aquaPigSpecular;
		ngun_base->GetChildren()[0]->GetMeshes()[0]->m_specular = aquaPigSpecular;
		nhull->GetChildren()[0]->GetMeshes()[0]->m_specular = aquaPigSpecular;
		npropeller->GetChildren()[0]->GetMeshes()[0]->m_specular = aquaPigSpecular;
		nwing_left->GetChildren()[0]->GetMeshes()[0]->m_specular = aquaPigSpecular;
		nwing_right->GetChildren()[0]->GetMeshes()[0]->m_specular = aquaPigSpecular;
